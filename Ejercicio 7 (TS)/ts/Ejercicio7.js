...
media(7.6, 5, 5);
let vjs = ["Mario Oddisey", "Pokemon Diamante Brillante", "Super Mario 64", "League of Legends", "Dark Souls"];
isNotMario(vjs);
factorial(3);
