...
let h1 = new Historial("1", 10, 5, 0);
let j1 = new Jugador("7", "Joao Felix", 22, "Portugal", h1);
let h2 = new Historial("2", 4, 12, 1);
let j2 = new Jugador("14", "Marcos LLorente", 27, "España", h2);
let h3 = new Historial("3", 14, 8, 0);
let j3 = new Jugador("10", "Angel Correa", 27, "Argentina", h3);
let f = new Date("04-26-1903");
let t = [j1, j2, j3];
let e = new Equipo("1", "Club Atletico de Madrid", f, t);
...
let h4 = new Historial("1", 7, 3, 0);
let j4 = new Jugador("11", "Thomas Lemar", 26, "Francia", h4);
e.addJugador(j4);
